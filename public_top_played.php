			...
			<div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="public_top_played.php">Top Played</a></li>
		...
		<div class="container-fluid">
			<div class="row">
						...
						<form action="" role="form" id="rateForm" class="form-horizontal">
							...
							<div class="form-group">
								<div class="col-sm-1 col-sm-offset-3">
									<button class='btn btn-primary' type='submit' id='searchBtn'>Show Top Played Songs</button>
								</div>
				...
				<div class="col-sm-12 main">
					<h2 class="sub-header">Top Played</h2>
					<div id="results"></div>
				</div>
			</div>
		</div>
...
$( '#rateForm' ).on('submit', function(elem){
	...
	$.ajax({type: "POST",
			url: "public_top_played_helper.php",
